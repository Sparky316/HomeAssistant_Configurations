...
from homeassistant.components.cover import (
    CoverEntity, SUPPORT_OPEN, SUPPORT_CLOSE, SUPPORT_STOP, SUPPORT_SET_POSITION)
from custom_components.lutron_qse import (
    CONF_IGNORE, LUTRON_QSE_INSTANCE, LUTRON_QSE_IGNORE, LutronQSEDevice)

_LOGGER = logging.getLogger(__name__ + "_cover")
...
class LutronQSECover(LutronQSEDevice, CoverEntity):
